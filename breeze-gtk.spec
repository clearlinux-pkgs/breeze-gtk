...
Version  : 5.26.1
Release  : 75
URL      : https://download.kde.org/stable/plasma/5.26.1/breeze-gtk-5.26.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.1/breeze-gtk-5.26.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.1/breeze-gtk-5.26.1.tar.xz.sig
...
%prep
%setup -q -n breeze-gtk-5.26.1
cd %{_builddir}/breeze-gtk-5.26.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1666278698
mkdir -p clr-build
pushd clr-build
