...
Version  : 5.26.5
Release  : 79
URL      : https://download.kde.org/stable/plasma/5.26.5/breeze-gtk-5.26.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.5/breeze-gtk-5.26.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.5/breeze-gtk-5.26.5.tar.xz.sig
...
%prep
%setup -q -n breeze-gtk-5.26.5
cd %{_builddir}/breeze-gtk-5.26.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673291801
mkdir -p clr-build
pushd clr-build
