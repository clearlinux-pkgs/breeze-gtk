...
Version  : 6.1.3
Release  : 107
URL      : https://download.kde.org/stable/plasma/6.1.3/breeze-gtk-6.1.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.3/breeze-gtk-6.1.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.3/breeze-gtk-6.1.3.tar.xz.sig
...
%setup -q -n breeze-gtk-6.1.3
cd %{_builddir}/breeze-gtk-6.1.3
pushd ..
cp -a breeze-gtk-6.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721144546
mkdir -p clr-build
pushd clr-build
