...
Source0  : https://download.kde.org/stable/plasma/5.14.0/breeze-gtk-5.14.0.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.0/breeze-gtk-5.14.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1539108537
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
