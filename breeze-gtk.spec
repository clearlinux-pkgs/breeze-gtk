...
Source0  : https://download.kde.org/stable/plasma/5.24.1/breeze-gtk-5.24.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.24.1/breeze-gtk-5.24.1.tar.xz.sig
...
%prep
%setup -q -n breeze-gtk-5.24.1
cd %{_builddir}/breeze-gtk-5.24.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1645026626
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/breeze-gtk-5.24.1/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/breeze-gtk/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/breeze-gtk-5.24.1/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/breeze-gtk/3c3d7573e137d48253731c975ecf90d74cfa9efe
pushd clr-build
%make_install
popd
