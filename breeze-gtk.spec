...
Version  : 6.1.0
Release  : 104
URL      : https://download.kde.org/stable/plasma/6.1.0/breeze-gtk-6.1.0.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.0/breeze-gtk-6.1.0.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.0/breeze-gtk-6.1.0.tar.xz.sig
...
%setup -q -n breeze-gtk-6.1.0
cd %{_builddir}/breeze-gtk-6.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1718818960
mkdir -p clr-build
pushd clr-build
