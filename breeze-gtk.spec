...
Version  : 5.27.3
Release  : 84
URL      : https://download.kde.org/stable/plasma/5.27.3/breeze-gtk-5.27.3.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.3/breeze-gtk-5.27.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.3/breeze-gtk-5.27.3.tar.xz.sig
...
%prep
%setup -q -n breeze-gtk-5.27.3
cd %{_builddir}/breeze-gtk-5.27.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679511744
mkdir -p clr-build
pushd clr-build
