...
Version  : 5.27.1
Release  : 82
URL      : https://download.kde.org/stable/plasma/5.27.1/breeze-gtk-5.27.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.1/breeze-gtk-5.27.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.1/breeze-gtk-5.27.1.tar.xz.sig
...
%prep
%setup -q -n breeze-gtk-5.27.1
cd %{_builddir}/breeze-gtk-5.27.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677183800
mkdir -p clr-build
pushd clr-build
