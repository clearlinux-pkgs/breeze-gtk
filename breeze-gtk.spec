...
Source0  : https://download.kde.org/stable/plasma/5.13.5/breeze-gtk-5.13.5.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.13.5/breeze-gtk-5.13.5.tar.xz.sig
Summary  : No detailed summary available
Group    : Development/Tools
License  : LGPL-2.1
Requires: breeze-gtk-license
Requires: breeze-gtk-data
...
export LANG=C
export SOURCE_DATE_EPOCH=1536085711
mkdir clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
export SOURCE_DATE_EPOCH=1536085711
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/breeze-gtk
cp COPYING.LIB %{buildroot}/usr/share/doc/breeze-gtk/COPYING.LIB
pushd clr-build
%make_install
popd
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/breeze-gtk/COPYING.LIB
