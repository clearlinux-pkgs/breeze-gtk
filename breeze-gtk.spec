...
Source0  : https://download.kde.org/stable/plasma/6.2.5/breeze-gtk-6.2.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.5/breeze-gtk-6.2.5.tar.xz.sig
...
%setup -q -n breeze-gtk-6.2.5
cd %{_builddir}/breeze-gtk-6.2.5
pushd ..
cp -a breeze-gtk-6.2.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1736179695
mkdir -p clr-build
pushd clr-build
