...
Version  : 5.27.9
Release  : 90
URL      : https://download.kde.org/stable/plasma/5.27.9/breeze-gtk-5.27.9.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.9/breeze-gtk-5.27.9.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.9/breeze-gtk-5.27.9.tar.xz.sig
...
%prep
%setup -q -n breeze-gtk-5.27.9
cd %{_builddir}/breeze-gtk-5.27.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698280484
mkdir -p clr-build
pushd clr-build
