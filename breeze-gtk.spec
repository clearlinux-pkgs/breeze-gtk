...
Version  : 6.3.1
Release  : 118
URL      : https://download.kde.org/stable/plasma/6.3.1/breeze-gtk-6.3.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.3.1/breeze-gtk-6.3.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.1/breeze-gtk-6.3.1.tar.xz.sig
...
%setup -q -n breeze-gtk-6.3.1
cd %{_builddir}/breeze-gtk-6.3.1
pushd ..
cp -a breeze-gtk-6.3.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739899662
mkdir -p clr-build
pushd clr-build
