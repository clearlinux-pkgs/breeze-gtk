...
Source0  : https://download.kde.org/stable/plasma/5.16.3/breeze-gtk-5.16.3.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.16.3/breeze-gtk-5.16.3.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1562722536
mkdir -p clr-build
pushd clr-build
