...
Source0  : https://download.kde.org/stable/plasma/6.2.4/breeze-gtk-6.2.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.2.4/breeze-gtk-6.2.4.tar.xz.sig
...
%setup -q -n breeze-gtk-6.2.4
cd %{_builddir}/breeze-gtk-6.2.4
pushd ..
cp -a breeze-gtk-6.2.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735196265
mkdir -p clr-build
pushd clr-build
