...
Source0  : https://download.kde.org/stable/plasma/5.14.3/breeze-gtk-5.14.3.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.3/breeze-gtk-5.14.3.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1541529977
mkdir -p clr-build
pushd clr-build
%cmake ..
