...
Source0  : https://download.kde.org/stable/plasma/5.27.6/breeze-gtk-5.27.6.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.6/breeze-gtk-5.27.6.tar.xz.sig
...
%prep
%setup -q -n breeze-gtk-5.27.6
cd %{_builddir}/breeze-gtk-5.27.6
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1687282787
mkdir -p clr-build
pushd clr-build
