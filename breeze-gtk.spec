...
Version  : 5.26.4
Release  : 78
URL      : https://download.kde.org/stable/plasma/5.26.4/breeze-gtk-5.26.4.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.26.4/breeze-gtk-5.26.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.4/breeze-gtk-5.26.4.tar.xz.sig
...
%prep
%setup -q -n breeze-gtk-5.26.4
cd %{_builddir}/breeze-gtk-5.26.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1669815740
mkdir -p clr-build
pushd clr-build
