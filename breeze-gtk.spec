...
Source0  : https://download.kde.org/stable/plasma/5.27.4/breeze-gtk-5.27.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.4/breeze-gtk-5.27.4.tar.xz.sig
...
%prep
%setup -q -n breeze-gtk-5.27.4
cd %{_builddir}/breeze-gtk-5.27.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680712782
mkdir -p clr-build
pushd clr-build
