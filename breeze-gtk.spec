...
Version  : 5.27.2
Release  : 83
URL      : https://download.kde.org/stable/plasma/5.27.2/breeze-gtk-5.27.2.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.27.2/breeze-gtk-5.27.2.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.2/breeze-gtk-5.27.2.tar.xz.sig
...
%prep
%setup -q -n breeze-gtk-5.27.2
cd %{_builddir}/breeze-gtk-5.27.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677599333
mkdir -p clr-build
pushd clr-build
