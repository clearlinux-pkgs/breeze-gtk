...
Source0  : https://download.kde.org/stable/plasma/5.25.4/breeze-gtk-5.25.4.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.25.4/breeze-gtk-5.25.4.tar.xz.sig
...
%prep
%setup -q -n breeze-gtk-5.25.4
cd %{_builddir}/breeze-gtk-5.25.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659710300
mkdir -p clr-build
pushd clr-build
