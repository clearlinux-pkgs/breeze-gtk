...
Version  : 6.1.1
Release  : 105
URL      : https://download.kde.org/stable/plasma/6.1.1/breeze-gtk-6.1.1.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.1/breeze-gtk-6.1.1.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.1/breeze-gtk-6.1.1.tar.xz.sig
...
%setup -q -n breeze-gtk-6.1.1
cd %{_builddir}/breeze-gtk-6.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719416926
mkdir -p clr-build
pushd clr-build
