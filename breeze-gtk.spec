...
Version  : 5.14.5
Release  : 8
URL      : https://download.kde.org/stable/plasma/5.14.5/breeze-gtk-5.14.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.14.5/breeze-gtk-5.14.5.tar.xz
Source99 : https://download.kde.org/stable/plasma/5.14.5/breeze-gtk-5.14.5.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1546961821
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
