...
Source0  : https://download.kde.org/stable/plasma/6.0.3/breeze-gtk-6.0.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.0.3/breeze-gtk-6.0.3.tar.xz.sig
...
%setup -q -n breeze-gtk-6.0.3
cd %{_builddir}/breeze-gtk-6.0.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1713227272
mkdir -p clr-build
pushd clr-build
