...
%prep
%setup -q -n breeze-gtk-5.23.0
cd %{_builddir}/breeze-gtk-5.23.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1634348421
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/breeze-gtk-5.23.0/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/breeze-gtk/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/breeze-gtk-5.23.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/breeze-gtk/3c3d7573e137d48253731c975ecf90d74cfa9efe
pushd clr-build
%make_install
popd
