...
Version  : 5.23.5
Release  : 61
URL      : https://download.kde.org/stable/plasma/5.23.5/breeze-gtk-5.23.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/5.23.5/breeze-gtk-5.23.5.tar.xz
...
%prep
%setup -q -n breeze-gtk-5.23.5
cd %{_builddir}/breeze-gtk-5.23.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641315994
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/breeze-gtk-5.23.5/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/breeze-gtk/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/breeze-gtk-5.23.5/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/breeze-gtk/3c3d7573e137d48253731c975ecf90d74cfa9efe
pushd clr-build
%make_install
popd
