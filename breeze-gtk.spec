...
Source0  : https://download.kde.org/stable/plasma/6.3.3/breeze-gtk-6.3.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.3.3/breeze-gtk-6.3.3.tar.xz.sig
...
%setup -q -n breeze-gtk-6.3.3
cd %{_builddir}/breeze-gtk-6.3.3
pushd ..
cp -a breeze-gtk-6.3.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742453658
mkdir -p clr-build
pushd clr-build
