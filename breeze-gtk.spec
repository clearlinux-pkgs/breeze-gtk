...
Source0  : https://download.kde.org/stable/plasma/5.26.3/breeze-gtk-5.26.3.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.26.3/breeze-gtk-5.26.3.tar.xz.sig
...
%prep
%setup -q -n breeze-gtk-5.26.3
cd %{_builddir}/breeze-gtk-5.26.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1667920345
mkdir -p clr-build
pushd clr-build
