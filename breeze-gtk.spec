...
Source0  : https://download.kde.org/stable/plasma/5.27.5/breeze-gtk-5.27.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/5.27.5/breeze-gtk-5.27.5.tar.xz.sig
...
%prep
%setup -q -n breeze-gtk-5.27.5
cd %{_builddir}/breeze-gtk-5.27.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684788082
mkdir -p clr-build
pushd clr-build
