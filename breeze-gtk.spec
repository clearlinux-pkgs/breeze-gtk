...
Version  : 6.1.5
Release  : 111
URL      : https://download.kde.org/stable/plasma/6.1.5/breeze-gtk-6.1.5.tar.xz
Source0  : https://download.kde.org/stable/plasma/6.1.5/breeze-gtk-6.1.5.tar.xz
Source1  : https://download.kde.org/stable/plasma/6.1.5/breeze-gtk-6.1.5.tar.xz.sig
...
%setup -q -n breeze-gtk-6.1.5
cd %{_builddir}/breeze-gtk-6.1.5
pushd ..
cp -a breeze-gtk-6.1.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725987153
mkdir -p clr-build
pushd clr-build
